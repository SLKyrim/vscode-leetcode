...
public:
    string validIPAddress(string IP) {
        regex matchIPv4("((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])");
        regex matchIPv6("(([0-9a-fA-F]{1,4})\\:){7}([0-9a-fA-F]{1,4})");
        if (regex_match(IP, matchIPv4)) {
            return "IPv4";
        }
        if (regex_match(IP, matchIPv6)) {
            return "IPv6";
        }
        return "Neither";
    }
