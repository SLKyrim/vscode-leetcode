...
点菜展示表如下所示：   
Table,Beef Burrito,Ceviche,Fried Chicken,Water    
3$\qquad\qquad$,0$\qquad\qquad$,2$\qquad\qquad$,1$\qquad\qquad$,0   
5$\qquad\qquad$,0$\qquad\qquad$,1$\qquad\qquad$,0$\qquad\qquad$,1   
10$\qquad\qquad$,1$\qquad\qquad$,0$\qquad\qquad$,0$\qquad\qquad$,0   
