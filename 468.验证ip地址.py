...
class Solution:
    def validIPAddress(self, IP: str) -> str:
        matchIpv4 = re.match(r'(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])', IP)
        matchIpv6 = re.match(r'([0-9a-fA-F]{1,4})\:([0-9a-fA-F]{1,4})\:([0-9a-fA-F]{1,4})\:([0-9a-fA-F]{1,4})\:([0-9a-fA-F]{1,4})\:([0-9a-fA-F]{1,4})\:([0-9a-fA-F]{1,4})\:([0-9a-fA-F]{1,4})', IP)
        if matchIpv4:
